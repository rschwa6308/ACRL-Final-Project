...
ref_traj_xs_dubins = dubins_main(dubins_start_pose, dubins_end_pose, rover_mpc_dubins.min_turning_radius*4, rover_mpc_dubins.wheel_angle_limit, rover_mpc_dubins.velocity_limit, dt=0.05)
...
results = [{'label':"Ref Stabilizing", 'us': ref_traj_us_stablizing, 'xs': ref_traj_xs_stablizing, 'color': 'tab:blue', 'zorder': 0}, 
           {'label':"Ref Dubin's", 'us': ref_traj_us_dubins, 'xs': ref_traj_xs_dubins, 'color': 'tab:orange', 'zorder': 1},
           {'label':"MPC Stabilizing", 'us': us_stabilizing, 'xs': xs_stabilizing, 'color': 'tab:green', 'zorder': 0},
           {'label':"MPC Dubin's", 'us': us_dubins, 'xs': xs_dubins, 'color': 'tab:red', 'zorder': 1}]
